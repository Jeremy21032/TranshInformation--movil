...
export const Home = () => {
  ...
  var maplocations = {
    ...
    lcom: require(`../json/La Comuna.json`),
    rmpb: require(`../json/Rumipamba.json`),
    carol: require(`../json/Carolina.json`),
  };
  const getData = () => {
    console.log("*********************************************************");
    console.log("*********************************************************");
    console.log(global.direccionBase);
    console.log("*********************************************************");
    console.log("*********************************************************");
    ...
    } else if (global.direccionBase == "lcom") {
      coordinates = maplocations.lcom;
    } else if (global.direccionBase == "rmpb") {
      coordinates = maplocations.rmpb;
    } else if (global.direccionBase == "carol") {
      coordinates = maplocations.carol;
    }
      ...
      <ScrollView>
        ...
        >
          <Text style={{ color: paperTheme.colors.text }}>
            Bienvenido {global.name} {global.lastName} {name}
          </Text>
