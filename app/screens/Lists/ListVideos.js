  ...
  return (
    <ListItem
      containerStyle={{
        ...
        marginVertical: 2,
        backgroundColor:
          paperTheme.dark == true ? styles.colors.black : styles.colors.white,
      }}
      onPress={() => {
    ...
    >
      <ListItem.Content style={{ flexDirection: "column" }}>
        <Image
          source={{ uri: infoVideos.prevImg }}
          style={{ height: 170, width: Dimensions.get("window").width - 50 , alignSelf: "center",marginHorizontal:10}}
        />
        <View
          style={{
            flexDirection: "row",
